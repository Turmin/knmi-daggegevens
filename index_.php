                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-primary" type="button" id="todayBtn" title="Ga naar vandaag">
                                    <i class="bi bi-calendar-today"></i> <span class="d-none d-sm-inline">Vandaag</span>
                                </button>
                            </div>
                        </div>
                        <div class="col-md-6">
